module.exports = {
  ...
  description: {
    en: 'RyxEx is a decentralized exchange for Ethereum tokens.',
    cn: 'RyxEx是去中心化的以太坊交易平台。',
    fr: "RyxEx est une bourse d'échange de jetons ethereum décentralisé.",
    es: 'RyxEx se ha posicionado como la primera bolsa de cambio de cryptomonedas y symbolicos de la blockchain Ethereum.',
    // cn:'RyxEx是无中心的以太坊交易平台。'
  },
  Smart_Contract: {
    en: 'Smart Contract',
    cn: '智能合约',
  ...
  only_7_days: {
    en: 'Note: RyxEx will only show recent transactions.',
    cn: '注意：RyxEx只会显示最近的交易。',
    fr: 'Remarque: RyxEx affichera uniquement les transactions récentes.',
    es: 'Nota: RyxEx sólo mostrará transacciones recientes.',
  },
  ...
  ryxex_desc: {
    en: 'RyxEx &#8212; decentralized token exchange',
    cn: 'RyxEx &#8212; 去中心化交易',
    // cn:'RyxEx &#8212; 无中心交易'
    fr: 'RyxEx &#8212; échange de jetons décentralisé',
    es: 'RyxEx &#8212; échange de jetons décentralisé',
  },
  etheropt_desc: {
  ...
  aug032016_announcement: {
    en: 'RyxEx has moved to a new smart contract. Go to the bottom of the page and switch to the old one if you have a balance there you need to withdraw.',
    cn: 'RyxEx更新了智能合约。如果你要提取余额，请到本页底部转成旧的合约并进行提取。',
    // cn:'RyxEx迁移到了新的智能合约。如果你要提取余额，请到本页底部转成旧的。'
    fr: "RyxEx a ete modifié pour un nouveau smart contract. Allez au bas de page et permutez le avec l'ancien s'il reste du solde à retirer.",
  },
  aug302016: {
    en: 'August 30, 2016',
    cn: '2016年8月3日',
  ...
  aug302016_announcement: {
    ...
    cn: 'RyxEx更新了智能合约。如果你要提取余额，请到本页底部转成旧的合约并进行提取。',
    // cn:'RyxEx迁移到了新的智能合约。如果你要提取余额，请到本页底部转成旧的。'
    fr: "RyxEx utilise un nouveau smart contract. Allez au bas de page et permutez le avec l'ancien s'il vous reste du solde à retirer.",
    es: 'RyxEx utiliza un nuevo contrato inteligente.',
  },
  new_account: {
    en: 'New account',
    cn: '新账号',
  ...
  deposit_withdraw_2: {
    en: 'Under "Balances," you will see your balance for each of the two currencies you selected. This is the balance you have deposited to RyxEx from your Ethereum account.',
    cn: '在“余额”下面，你可以看到两种币的各自的余额，这是从你的以太坊账号充值的余额。',
    fr: 'Sous "Soldes" vous trouverez le solde pour chacune des deux devises selectionnées. C\'est le solde que vous venez de déposer sur ryxex depuis votre compte Ethereum',
  ...
  deposit_withdraw_4: {
    en: 'To deposit, click the "Deposit" tab, pick a token, enter an amount you would like to deposit from your Ethereum account into RyxEx, and click "Deposit."',
    cn: '充值点“充值”，选择一种币，输入从以太坊账号进入RyxEx的充值数量，再点“充值”。',
  ...
  trade_3: {
    en: 'RyxEx supports resting orders (adding liquidity) and trading against existing resting orders (taking liquidity).',
    cn: 'RyxEx支持“待定下单”（resting order）来增加流动性，以及交易“待定下单”来减少流动性。',
    fr: "RyxEx supportes les ordres restant (l'ajout de liquidite) et marchander contre des ordres restant (prise de liquidite).",
    es: 'RyxEx apoya descansando órdenes tales como la adición de liquidez y el comercio contre órdenes existentes como descansando Tomando liquidez..',
  },
  trade_4: {
  ...
  trade_6: {
    en: 'When you submit a resting order, it gets broadcast to the world. The current broadcast channel is a Gitter chat room, but RyxEx also supports using Ethereum events as a fallback broadcast mechanism.',
    cn: '但你提交了一个“待定下单”后，它会广播到全球。现在的传播渠道是Gitter聊天室，但是RyxEx也支持以太坊事件机制，用来保底。',
